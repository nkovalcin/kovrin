"""
LATTICE v2 Intent Schema

Intents in LATTICE v2 are expressed as AMR-inspired graph structures
...
# ─── Speculation Tier (from Speculative Actions research) ───
...
# ═══════════════════════════════════════════
# THE LATTICE v2 INTENT
# ═══════════════════════════════════════════
class IntentV2(BaseModel):
    """A LATTICE v2 Intent — the primary input to the system.
