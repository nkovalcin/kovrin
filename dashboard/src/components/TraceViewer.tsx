...
const EVENT_COLORS: Record<string, string> = {
  ...
  AGENT_ASSIGNMENT: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/30',
  AGENT_ASSIGNED: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/30',
  ...
  MULTI_AGENT_MODE: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/30',
